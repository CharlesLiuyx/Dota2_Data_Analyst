...
def evaluate(train_data, test_data, cv=5, save_model=None):
    ...
    :param train_data: list containing x_train and y_train
    :param test_data: list containing x_test and y_test
    :param cv: number of folds to use in cross validation
    :param save_model: if given, the model is saved to this path

    :return train size, test size, roc_auc score
